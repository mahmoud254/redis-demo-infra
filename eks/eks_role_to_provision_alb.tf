# Note that role is needed since alb ingress will be used to 
# provison alb ingress in our cluster
  ...
  "Statement": [
    {
      ...
      "Condition": {
        "StringEquals": {
          "${aws_iam_openid_connect_provider.oidc.url}:sub": "system:serviceaccount:kube-system:aws-load-balancer-controller",
